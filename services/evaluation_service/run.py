#!/usr/bin/env python3
"""
Evaluation Service - Standalone Runner
...
Usage:
    ...
    REDIS_URL=redis://localhost:6379 python run.py
...
def main():
    ...
    # Initialize service
    from services.evaluation_service.service import EvaluationService
    from services.evaluation_service.server import serve

    service = EvaluationService.from_config(config)
