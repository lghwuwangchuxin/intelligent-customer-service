#!/usr/bin/env python3
"""
Multi-Agent Service - Standalone Runner
...
def main():
    ...
    # Initialize service
    from services.multi_agent_service.service import MultiAgentService
    from services.multi_agent_service.server import serve

    service = MultiAgentService.from_config(config)
