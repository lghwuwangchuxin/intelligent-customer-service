#!/usr/bin/env python3
"""
LLM Manager Service - Standalone Runner
...
Usage:
    ...
    LLM_PROVIDER=openai LLM_MODEL=gpt-4o python run.py
...
def main():
    ...
    SERVICE_NAME = "llm-manager-service"
    ...
    # Initialize service
    from services.llm_manager_service.service import LLMManagerService
    from services.llm_manager_service.server import serve

    service = LLMManagerService.from_config(config)
