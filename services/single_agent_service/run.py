#!/usr/bin/env python3
"""
Single Agent Service - Standalone Runner
...
def main():
    ...
    # Initialize service
    from services.single_agent_service.service import SingleAgentService
    from services.single_agent_service.server import serve

    service = SingleAgentService.from_config(config)
